...
import com.fitness.gateway.GatewaySecurityProperties;
import com.fitness.gateway.KeycloakUserSyncFilter;
...
public class WebClientConfig {
    ...
    public WebClient userServiceWebClient(
        ...
        return webClientBuilder
                ...
                .defaultHeader(KeycloakUserSyncFilter.INTERNAL_TOKEN_HEADER, securityProperties.resolvedInternalToken())
                .build();
    }
}
